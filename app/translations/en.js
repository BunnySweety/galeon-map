/*eslint-disable*/
// English translation file for the Galeon Hospitals Map application
...
export const messages = {
  ...
  'CSV export will be available soon': 'CSV export will be available soon',
  ...
  'Search by name, address, website...': 'Search by name, address, website...',
  'Search by name, address...': 'Search by name, address...',
  'Filters': 'Filters',
  'Clear search': 'Clear search',
  'hospital(s) found': 'hospital(s) found',
  'Search Results': 'Search Results',
  'Filtered from': 'Filtered from',
  'total': 'total',
  'hospitals total': 'hospitals total',
  'more hospitals': 'more hospitals',
  ...
  'CSV export completed successfully!': 'CSV export completed successfully!',
  ...
  'Failed to export CSV. Please try again.': 'Failed to export CSV. Please try again.',

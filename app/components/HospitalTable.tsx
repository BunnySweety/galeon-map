...
const HospitalTable: React.FC<HospitalTableProps> = ({ className = '' }) => {
  ...
  const exportData = useCallback((exportType: 'pdf' | 'xls' | 'json') => {
  ...
  return (
    <div className={`bg-white p-4 md:p-6 rounded-lg shadow-md overflow-auto ${className}`}>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
        <h2 className="text-lg md:text-xl font-semibold">{_('Hospitals')}</h2>
        <button

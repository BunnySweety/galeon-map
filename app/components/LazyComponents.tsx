...
export const LazyHospitalTable = dynamic(
  () => import('./HospitalTable'),
  {
    ssr: false,
    loading: () => (
...
export const LazyTimelineControl = dynamic(
...
export const LazyHospitalDetail = dynamic(
...
export const LazyExportUtils = {
  ...
  exportToXLS: () => import('../utils/export-utils').then(mod => mod.exportToXLS),
  exportToJSON: () => import('../utils/export-utils').then(mod => mod.exportToJSON),
  exportFilteredHospitals: () => import('../utils/export-utils').then(mod => mod.exportFilteredHospitals),
};

...
describe('MapControls', () => {
  ...
  it('should show correct position for mobile view', () => {
    ...
    const controlsContainer = screen.getByRole('button', {
      name: /show my location/i,
    }).parentElement;
  ...
  it('should show different icon when locating', () => {
    ...
    let locationIcon = screen
      .getByRole('button', { name: /show my location/i })
      .querySelector('svg');
  ...
  it('should show different fullscreen icon based on state', () => {
    ...
    rerender(
      <MapControls
        {...defaultProps}
        isFullscreen={true}
        getFullscreenTooltip={() => 'Exit fullscreen'}
      />
    );

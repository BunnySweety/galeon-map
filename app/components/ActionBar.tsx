  ...
  return (
    <div className={`${className}`}>
      ...
      >
        ...
        <PopupMenu title={_('Export data')} isVisible={showExportMenu} anchorRef={actionBarRef} id="export-menu">
        ...
        <PopupMenu title={_('Share')} isVisible={showShareMenu} anchorRef={actionBarRef} id="share-menu">

    ...
    >
      ...
      >
        ...
        >
          ...
          >
            A community-driven map of deployed hospitals, with support from the Galeon team. Data is
            not official and may evolve over time.
          </p>
                ...
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  <div
                    style={{
                      ...
                      border: selectedFilters.deployed
                        ? '2.5px solid #ffffff'
                        : '2px solid #3b82f6',
                      marginRight: '8px',
                      transition: 'all 0.2s ease',
                  ...
                  <span
                    style={{
                      ...
                      fontWeight: '500',
                      textShadow: selectedFilters.deployed
                ...
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  <span
                    style={{
                      ...
                      transition: 'color 0.2s ease',
                      fontWeight: '500',
                      textShadow: selectedFilters.signed
        ...
        >
          ...
          >
            <svg
              style={{ width: '14px', height: '14px', color: 'white', marginRight: '6px' }}
              fill="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          >
            ...
            <option value="fr" style={{ backgroundColor: '#1e293b' }}>
              🇫🇷 Français
            </option>
          </select>
        </div>

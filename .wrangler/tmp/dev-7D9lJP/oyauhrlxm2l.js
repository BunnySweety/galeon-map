...
// .wrangler/tmp/bundle-JVOUoY/checked-fetch.js
...
// .wrangler/tmp/pages-oF06Jz/bundledWorker-0.7120612434649254.mjs
    ...
    try {
      ...
      if (pathname.startsWith("/api/")) {
        ...
        if (hospitalIdMatch) {
          ...
          try {
            const apiResponse = await fetch(new URL(`/api/hospitals/${id}.json`, url.origin));
            if (apiResponse.ok) {
            ...
            const indexResponse = await fetch(new URL(`/api/hospitals/index.json`, url.origin));
            if (indexResponse.ok) {
              const hospitals = await indexResponse.json();
        ...
        if (pathname === "/api/hospitals") {
          ...
          try {
            const apiResponse = await fetch(new URL("/api/hospitals/index.json", url.origin));
            if (apiResponse.ok) {
              return new Response(await apiResponse.text(), {
                headers: {
                  "Content-Type": "application/json",
            ...
            return new Response(JSON.stringify({ error: "Hospitals data not available" }), {
              status: 404,
              headers: {
                "Content-Type": "application/json",
                "Access-Control-Allow-Origin": "*"
      ...
      if (pathname.startsWith("/hospitals/")) {
        console.log(`Serving hospital page for: ${pathname}`);
        try {
...
// .wrangler/tmp/pages-oF06Jz/oyauhrlxm2l.js
...
// .wrangler/tmp/bundle-JVOUoY/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-JVOUoY/middleware-loader.entry.ts
...
//# sourceMappingURL=oyauhrlxm2l.js.map
